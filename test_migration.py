...
def test_knowledge_graph():
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️ Knowledge graph query test failed (this is expected for new graphs): {e}")
...
def test_unified_storage():
    ...
    print("\n🔗 Testing unified storage capabilities...")
    try:
        storage = get_storage_client()
        ...
        print(f"✅ Document summary returned {len(summary)} documents")
