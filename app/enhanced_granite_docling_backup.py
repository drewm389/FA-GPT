...
class EnhancedGraniteDoclingExtractor:
    ...
    def _extract_pdf_diagnostics(self, pdf_path: str):
        """Extract diagnostic information from PDF to help debug issues."""
        try:
            import fitz  # PyMuPDF
            ...
            logger.info(f"📋 PDF diagnostics: {json.dumps(structure, indent=2)}")
            doc.close()
        except Exception as diag_error:
            logger.log_exception(diag_error, "Diagnostic extraction failed")
